...
<?= $this->section('title') ?>
<title>Update Produk UMKM &mdash; SIPUTRI</title>
<?= $this->endSection() ?>
...
<section class="section">
        ...
        <div class="section-header-back">
          <a href="<?=site_url('admin/produk')?>" class="btn"><i class= "fas fa-arrow-left"></i></a>
        </div>
        <h1>Update Produk UMKM</h1>
        </div>
...
<div class="section-body">
        ...
        <div class="card-header">
            <h4>Edit Produk UMKM</h4>
          </div>
                 <div class="card-body col-md-6">
                <form action="<?=site_url('admin/produk/'.$penjualan->id_penjualan)?>" method="post" autocomplete="off">
                <?= csrf_field() ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="foto_produk" value="<?=$penjualan->foto_produk?>" class="form-control" required>
                    </div>
                    <div class="form-group">
