...
<section class="section">
        ...
        <div class="section-header-back">
          <a href="<?=site_url('admin/pelatihan')?>" class="btn"><i class= "fas fa-arrow-left"></i></a>
        </div>
...
<div class="section-body">
        ...
        <div class="card-header">
            <h4>Edit Data Pelatihan UMKM</h4>
                ...
                <form action="<?=site_url('admin/pelatihan/'.$pelatihan->id_pelatihan)?>" method="post" autocomplete="off">
                <?= csrf_field() ?>
