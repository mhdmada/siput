...
<head>
  ...
  <title>Tentang Aplikasi &mdash; SIPUTRI</title>
      ...
      <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item"><a href="<?=site_url('public/tentang')?>">Tentang Aplikasi</a></div>
            </div>
          </div>
          ...
          <div class="section-body">
            <div class="card">
              ...
              <img src="<?= base_url('uploads/content/' . esc($konten['gambar_konten'])); ?>" alt="tentang" height="400px" width="70%">
              </div>
            </div>
