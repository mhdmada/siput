...
class AdminPenjualan extends AdminBaseController
{
    public function index()
    {
         ...
         return view('admin/penjualan/get', $data);
    }
    ...
    public function store()
    {
        ...
        if($this->db->affectedRows() > 0 ) {
            return redirect()->to(site_url('admin/penjualan'))->with('success', 'Data Berhasil Disimpan');
        }
    }
    ...
    public function update($id)
    {
        ...
        return redirect()->to(site_url('admin/penjualan'))->with('success', 'Data Berhasil Diupdate');
    }

    public function destroy($id)
    {
        $this->db->table('penjualan')->where(['id_penjualan' => $id])->delete();
        return redirect()->to(site_url('admin/penjualan'))->with('success', 'Data Berhasil Dihapus');
    }
}
